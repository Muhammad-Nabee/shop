                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" placeholder="" id="input-email" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Password <span class="red">*</span></label>
                                    <input type="password" name="password" placeholder="" id="input-password" required class="form-control">
                                </div>
                            ...
                            <div class="col-md-12">
                                <input type="submit" value="Login" id="submit_login" class="btn-colour-blue">
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <label><input name="gender" value="male" type="radio" required @if(old('gender')  == 'male') checked @endif/> Male</label>
                                        </span>
                                            <span class="custom-radio mr-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile_no" required placeholder="" value="{{old('mobile_no')}}" id="mobile_no" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
