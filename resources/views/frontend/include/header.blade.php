                  ...
                  <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        @if(!empty($pharmacy_info->contact_number_p))
                            <ul class="contact_detail text-center text-lg-start">
                                <li><i class="ti-mobile"></i><span>{{$pharmacy_info->contact_number_p}}</span></li>
                            </ul>
                        @endif
                    </div>
                </div>
                  ...
                  <div class="text-center text-md-end">
                        <ul class="header_list">
                          {{-- <li><a href="compare.html"><i class="ti-control-shuffle"></i><span>Compare</span></a></li>
                            ...
                            <li><a href="{{route('customr-login')}}"><i class="ti-user"></i><span>Login</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
      ...
      <div class="container">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="{{url('/')}}">
                    <img class="logo_light" src="{{asset('new/assets/images/logo_light.png')}}" alt="logo" />
                    <img class="logo_dark" src="{{asset('new/assets/images/logo_dark.png')}}" alt="logo" />
                </a>
                                        ...
                                        <div class="d-lg-flex menu_banners row g-3 px-3">
                                            <div class="col-sm-4">
                                                <div class="header-banner">
                                                    <img src="new/assets/images/menu_banner11.jpg" alt="menu_banner1">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="header-banner">
                                                    <img src="new/assets/images/menu_banner22.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Wooden Chair</h4>
                                                        <a href="#">Shop now</a>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="header-banner">
                                                    <img src="new/assets/images/menu_banner33.jpg" alt="menu_banner3">
                                                    <div class="banne_info">
                                                        <h6>23% Off</h6>
                                                        <h4>Wooden Chair</h4>
                                                        <a href="#">Shop now</a>
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="new/assets/images/shop_banner1.jpg" alt="shop_banner"/>
                                                            </div>
                        ...
                        @foreach($menu['pharmacy_menu_links'] as $link)
                            ...
                            @if(count($link['childs']) > 0 )
                                ...
                                <li class="dropdown">
                                    ...
                                    <a href="{{ @$alink }}" {{ $target }} class="nav-link dropdown-toggle" >{{ @$link['title']}}</a>
                                    <ul class="dropdown-menu" role="menu">
                                        @foreach($link['childs'] as $child_link)
                                            ...
                                            @endphp
                                            <li class="nav-item">
                                                <a class="dropdown-item" href="{{ $child_sub_link }}" {{ $target }}> {{ $child_link['title'] }}</a>
                                            </li>
                                        @endforeach
                            ...
                            @else
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ $alink }}" {{ $target }}> {{ $link['title'] }}</a>
                                </li>
                            @endif
                        @endforeach
                    @endif
